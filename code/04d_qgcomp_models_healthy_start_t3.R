...
#' Summarize results
temp <- tibble(exposure_period = "t3",
               time_point = 0,
               outcome = "zbmi",
               group = "gis variables",
...
temp2 <- tibble(exposure_period = "t3",
                time_point = 0,
                outcome = "zbmi",
                group = "gis variables",
...
#' Plot
plot_name <- paste0("QGCOMP_", "t3", "_0", "_zbmi_hs.jpeg")
graphics.off()
...
#' Save the model
model_name <- "QGComp_t3_0_hs.rdata"
...
df_6 <- hs_data %>%
  filter(exp_period == "t3" & out_period == 6) %>%
  select(all_of(exps), all_of(covars), zbmi) %>%
  na.omit() %>%
  mutate_at(.vars = vars(all_of(scale_exp)), .funs = scale_this)
...
#' Plot
plot_name <- paste0("QGCOMP_", "t3", "_6", "_zbmi_hs.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_6)
dev.off()
...
#' Save the model
model_name <- "QGComp_t3_6_hs.rdata"
...
df_12 <- hs_data %>%
  filter(exp_period == "t3" & out_period == 12) %>%
  select(all_of(exps), all_of(covars), zbmi) %>%
  na.omit() %>%
  mutate_at(.vars = vars(all_of(scale_exp)), .funs = scale_this)
...
#' Plot
plot_name <- paste0("QGCOMP_", "t3", "_12", "_zbmi_hs.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
...
#' Save the model
model_name <- "QGComp_t3_12_hs.rdata"
...
df_24 <- hs_data %>%
  filter(exp_period == "t3" & out_period == 24) %>%
  select(all_of(exps), all_of(covars), zbmi) %>%
  na.omit() %>%
  mutate_at(.vars = vars(all_of(scale_exp)), .funs = scale_this)
...
#' Plot
plot_name <- paste0("QGCOMP_", "t3", "_24", "_zbmi_hs.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
...
#' Save the model
model_name <- "QGComp_t3_24_hs.rdata"
...
#' Plot
plot_name <- paste0("QGCOMP_", "t3", "_0", "_zbmi_st_hs.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_0)
dev.off()
...
#' Save the model
model_name <- "QGComp_t3_0_st_hs.rdata"
save(fit.qgcomp.c_0, fit.qgcomp.b_0,
     file = here::here("results/qgcomp_results", model_name))
...
#' Plot
plot_name <- paste0("QGCOMP_", "t3", "_6", "_zbmi_st_hs.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_6)
dev.off()
...
#' Save the model
model_name <- "QGComp_t3_6_st_hs.rdata"
save(fit.qgcomp.c_6, fit.qgcomp.b_6,
     file = here::here("results/qgcomp_results", model_name))
...
#' Plot
plot_name <- paste0("QGCOMP_", "t3", "_12", "_zbmi_st_hs.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_12)
dev.off()
...
#' Save the model
model_name <- "QGComp_t3_12_st_hs.rdata"
save(fit.qgcomp.c_12, fit.qgcomp.b_12,
     file = here::here("results/qgcomp_results", model_name))
...
#' Plot
plot_name <- paste0("QGCOMP_", "t3", "_24", "_zbmi_st_hs.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_24)
dev.off()
...
#' Save the model
model_name <- "QGComp_t3_24_st_hs.rdata"
save(fit.qgcomp.c_24, fit.qgcomp.b_24,
     file = here::here("results/qgcomp_results", model_name))
...
write_csv(gcomp_psi_results, file = here::here("results/qgcomp_results/psi_est", "qgcomp_t3_psi_estimates_hs.csv"))
write_csv(gcomp_weights_results, file = here::here("results/qgcomp_results/weights", "qgcomp_t3_weights_hs.csv"))