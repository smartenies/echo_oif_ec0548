...
model_name <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_md.rdata")
...
fit_pips <- ExtractPIPs(fit_bkmr) %>%
  mutate(exp_period = "pregnancy",
         out_period = 0,
         group = "gis variables")
pips_name <- paste0("BKMR_PIPs_", "pregnancy", "_", 0, "_zbmi_md.csv")
...
plot_name2 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_h25_md.jpeg")
...
plot_name1 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_h50_md.jpeg")
...
plot_name3 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_h75_md.jpeg")
...
ggplot(o_risk, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
  ...
  geom_pointrange()
plot_name4 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_overall_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name4),
       device = "jpeg", height = 4, width = 6, units = "in")
overall_name <- paste0("BKMR_overall_", "pregnancy", "_", 0, "_zbmi_md.csv")
...
ggplot(s_risk, aes(variable, est, ymin = est - 1.96*sd,
  ...
  coord_flip()
plot_name5 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_singvar_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name5),
       device = "jpeg", height = 6, width = 5, units = "in")
singvar_name <- paste0("BKMR_singvar_", "pregnancy", "_", 0, "_zbmi_md.csv")
write_csv(s_risk, file = here::here("results/bkmr_results/risks", singvar_name))

#' Saving results
model_name <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_results_md.rdata")
save(fit_pips, 
...
#' Save current results
model_name <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_md.rdata")
save(df, y, Z, X, fit_bkmr, file = here::here("results/bkmr_results", model_name))
...
jpeg(file = here::here("figs/bkmr_plots/", paste0("BKMR_trace_", "pregnancy",
                                                  "_", 6, "_zbmi_md.jpeg")))
par(mfrow=c(3,1))
TracePlot(fit = fit_bkmr, par = "beta")
TracePlot(fit = fit_bkmr, par = "sigsq.eps")
...
fit_pips <- ExtractPIPs(fit_bkmr) %>%
  mutate(exp_period = "pregnancy",
         out_period = 6,
         group = "gis variables")
pips_name <- paste0("BKMR_PIPs_", "pregnancy", "_", 6, "_zbmi_md.csv")
write_csv(fit_pips, file = here::here("results/bkmr_results/pips", pips_name))
...
ggplot(pred_univariate_25, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 25th percentile")
plot_name2 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_h25_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name2),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_50, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 50th percentile")
plot_name1 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_h50_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name1),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_75, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 75th percentile")
plot_name3 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_h75_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name3),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(o_risk, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
  ...
  ylab("Effect estimate") +
  geom_pointrange()
plot_name4 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_overall_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name4),
       device = "jpeg", height = 4, width = 6, units = "in")
overall_name <- paste0("BKMR_overall_", "pregnancy", "_", 6, "_zbmi_md.csv")
write_csv(o_risk, file = here::here("results/bkmr_results/risks", overall_name))
...
ggplot(s_risk, aes(variable, est, ymin = est - 1.96*sd,
  ...
  geom_pointrange(position = position_dodge(width = 0.75)) +
  coord_flip()
plot_name5 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_singvar_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name5),
       device = "jpeg", height = 6, width = 5, units = "in")
singvar_name <- paste0("BKMR_singvar_", "pregnancy", "_", 6, "_zbmi_md.csv")
write_csv(s_risk, file = here::here("results/bkmr_results/risks", singvar_name))

#' Saving results
model_name <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_results_md.rdata")
save(fit_pips, 
     pred_univariate_25, pred_univariate_50, pred_univariate_75,
     o_risk, s_risk,
     file = here::here("results/bkmr_results", model_name))
...
#' Save current results
model_name <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_md.rdata")
save(df, y, Z, X, fit_bkmr, file = here::here("results/bkmr_results", model_name))
...
fit_pips <- ExtractPIPs(fit_bkmr) %>%
  mutate(exp_period = "pregnancy",
         out_period = 12, 
         group = "gis variables")
pips_name <- paste0("BKMR_PIPs_", "pregnancy", "_", 12, "_zbmi_md.csv") 
write_csv(fit_pips, file = here::here("results/bkmr_results/pips", pips_name))
...
ggplot(pred_univariate_25, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 25th percentile")
plot_name2 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_h25_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name2),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_50, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 50th percentile")
plot_name1 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_h50_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name1),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_75, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 75th percentile")
plot_name3 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_h75_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name3),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(o_risk, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
  ...
  ylab("Effect estimate") +
  geom_pointrange()
plot_name4 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_overall_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name4),
       device = "jpeg", height = 4, width = 6, units = "in")
overall_name <- paste0("BKMR_overall_", "pregnancy", "_", 12, "_zbmi_md.csv") 
write_csv(o_risk, file = here::here("results/bkmr_results/risks", overall_name))
...
ggplot(s_risk, aes(variable, est, ymin = est - 1.96*sd, 
  ...
  geom_pointrange(position = position_dodge(width = 0.75)) + 
  coord_flip()
plot_name5 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_singvar_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name5),
       device = "jpeg", height = 6, width = 5, units = "in")
singvar_name <- paste0("BKMR_singvar_", "pregnancy", "_", 12, "_zbmi_md.csv") 
write_csv(s_risk, file = here::here("results/bkmr_results/risks", singvar_name))

#' Saving results
model_name <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_results_md.rdata")
save(fit_pips, 
     pred_univariate_25, pred_univariate_50, pred_univariate_75,
     o_risk, s_risk, 
     file = here::here("results/bkmr_results", model_name))
...
#' Save current results
model_name <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_st_md.rdata")
save(df, y, Z, X, fit_bkmr, file = here::here("results/bkmr_results", model_name))
...
fit_pips <- ExtractPIPs(fit_bkmr) %>%
  mutate(exp_period = "pregnancy",
         out_period = 0, 
         group = "st variables")
pips_name <- paste0("BKMR_PIPs_", "pregnancy", "_", 0, "_zbmi_st_md.csv") 
write_csv(fit_pips, file = here::here("results/bkmr_results/pips", pips_name))
...
ggplot(pred_univariate_25, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 25th percentile")
plot_name2 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_h25_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name2),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_50, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 50th percentile")
plot_name1 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_h50_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name1),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_75, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 75th percentile")
plot_name3 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_h75_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name3),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(o_risk, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
  ...
  ylab("Effect estimate") +
  geom_pointrange()
plot_name4 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_overall_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name4),
       device = "jpeg", height = 4, width = 6, units = "in")
overall_name <- paste0("BKMR_overall_", "pregnancy", "_", 0, "_zbmi_st_md.csv") 
write_csv(o_risk, file = here::here("results/bkmr_results/risks", overall_name))
...
ggplot(s_risk, aes(variable, est, ymin = est - 1.96*sd, 
  ...
  geom_pointrange(position = position_dodge(width = 0.75)) + 
  coord_flip()
plot_name5 <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_singvar_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name5),
       device = "jpeg", height = 6, width = 5, units = "in")
singvar_name <- paste0("BKMR_singvar_", "pregnancy", "_", 0, "_zbmi_st_md.csv") 
write_csv(s_risk, file = here::here("results/bkmr_results/risks", singvar_name))

#' Saving results
model_name <- paste0("BKMR_", "pregnancy", "_", 0, "_zbmi_results_st_md.rdata")
save(fit_pips, 
     pred_univariate_25, pred_univariate_50, pred_univariate_75,
     o_risk, s_risk, 
     file = here::here("results/bkmr_results", model_name))
...
#' Save current results
model_name <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_st_md.rdata")
save(df, y, Z, X, fit_bkmr, file = here::here("results/bkmr_results", model_name))
...
fit_pips <- ExtractPIPs(fit_bkmr) %>%
  mutate(exp_period = "pregnancy",
         out_period = 6, 
         group = "st variables")
pips_name <- paste0("BKMR_PIPs_", "pregnancy", "_", 6, "_zbmi_st_md.csv") 
write_csv(fit_pips, file = here::here("results/bkmr_results/pips", pips_name))
...
ggplot(pred_univariate_25, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 25th percentile")
plot_name2 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_h25_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name2),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_50, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 50th percentile")
plot_name1 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_h50_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name1),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_75, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 75th percentile")
plot_name3 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_h75_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name3),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(o_risk, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
  ...
  ylab("Effect estimate") +
  geom_pointrange()
plot_name4 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_overall_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name4),
       device = "jpeg", height = 4, width = 6, units = "in")
overall_name <- paste0("BKMR_overall_", "pregnancy", "_", 6, "_zbmi_st_md.csv") 
write_csv(o_risk, file = here::here("results/bkmr_results/risks", overall_name))
...
ggplot(s_risk, aes(variable, est, ymin = est - 1.96*sd, 
  ...
  geom_pointrange(position = position_dodge(width = 0.75)) + 
  coord_flip()
plot_name5 <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_singvar_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name5),
       device = "jpeg", height = 6, width = 5, units = "in")
singvar_name <- paste0("BKMR_singvar_", "pregnancy", "_", 6, "_zbmi_st_md.csv") 
write_csv(s_risk, file = here::here("results/bkmr_results/risks", singvar_name))

#' Saving results
model_name <- paste0("BKMR_", "pregnancy", "_", 6, "_zbmi_results_st_md.rdata")
save(fit_pips,      
     pred_univariate_25, pred_univariate_50, pred_univariate_75,
     o_risk, s_risk,
     file = here::here("results/bkmr_results", model_name))
...
#' Save current results
model_name <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_st_md.rdata")
save(df, y, Z, X, fit_bkmr, file = here::here("results/bkmr_results", model_name))
...
fit_pips <- ExtractPIPs(fit_bkmr) %>%
  mutate(exp_period = "pregnancy",
         out_period = 12, 
         group = "st variables")
pips_name <- paste0("BKMR_PIPs_", "pregnancy", "_", 12, "_zbmi_st_md.csv") 
write_csv(fit_pips, file = here::here("results/bkmr_results/pips", pips_name))
...
ggplot(pred_univariate_25, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 25th percentile")
plot_name2 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_h25_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name2),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_50, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 50th percentile")
plot_name1 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_h50_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name1),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred_univariate_75, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  ...
  facet_wrap(~ variable, scales = "free") +
  ylab("h(z) holding other variables at 75th percentile")
plot_name3 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_h75_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name3),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(o_risk, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
  ...
  ylab("Effect estimate") +
  geom_pointrange()
plot_name4 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_overall_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name4),
       device = "jpeg", height = 4, width = 6, units = "in")
overall_name <- paste0("BKMR_overall_", "pregnancy", "_", 12, "_zbmi_st_md.csv") 
write_csv(o_risk, file = here::here("results/bkmr_results/risks", overall_name))
...
ggplot(s_risk, aes(variable, est, ymin = est - 1.96*sd, 
  ...
  geom_pointrange(position = position_dodge(width = 0.75)) + 
  coord_flip()
plot_name5 <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_singvar_st_md.jpeg")
ggsave(filename = here::here("figs/bkmr_plots", plot_name5),
       device = "jpeg", height = 6, width = 5, units = "in")
singvar_name <- paste0("BKMR_singvar_", "pregnancy", "_", 12, "_zbmi_st_md.csv") 
write_csv(s_risk, file = here::here("results/bkmr_results/risks", singvar_name))

#' Saving results
model_name <- paste0("BKMR_", "pregnancy", "_", 12, "_zbmi_results_st_md.rdata")
save(fit_pips, 
     pred_univariate_25, pred_univariate_50, pred_univariate_75,
     o_risk, s_risk, 
     file = here::here("results/bkmr_results", model_name))
