...
#' Plot
plot_name <- paste0("QGCOMP_", "t2", "_0", "_zbmi_md.jpeg")
graphics.off()
...
#' Save the model
model_name <- "QGComp_t2_0_md.rdata"
...
#' Plot
plot_name <- paste0("QGCOMP_", "t2", "_6", "_zbmi_md.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_6)
dev.off()
...
#' Save the model
model_name <- "QGComp_t2_6_md.rdata"
...
#' Plot
plot_name <- paste0("QGCOMP_", "t2", "_12", "_zbmi_md.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
...
#' Save the model
model_name <- "QGComp_t2_12_md.rdata"
...
#' Plot
plot_name <- paste0("QGCOMP_", "t2", "_24", "_zbmi_md.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
...
#' Save the model
model_name <- "QGComp_t2_24_md.rdata"
...
#' Plot
plot_name <- paste0("QGCOMP_", "t2", "_0", "_zbmi_st_md.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_0)
dev.off()
...
#' Save the model
model_name <- "QGComp_t2_0_st_md.rdata"
save(fit.qgcomp.c_0, fit.qgcomp.b_0,
     file = here::here("results/qgcomp_results", model_name))
...
#' Plot
plot_name <- paste0("QGCOMP_", "t2", "_6", "_zbmi_st_md.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_6)
dev.off()
...
#' Save the model
model_name <- "QGComp_t2_6_st_md.rdata"
save(fit.qgcomp.c_6, fit.qgcomp.b_6,
     file = here::here("results/qgcomp_results", model_name))
...
#' Plot
plot_name <- paste0("QGCOMP_", "t2", "_12", "_zbmi_st_md.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_12)
dev.off()
...
#' Save the model
model_name <- "QGComp_t2_12_st_md.rdata"
save(fit.qgcomp.c_12, fit.qgcomp.b_12,
     file = here::here("results/qgcomp_results", model_name))
...
#' Plot
plot_name <- paste0("QGCOMP_", "t2", "_24", "_zbmi_st_md.jpeg")
graphics.off()
jpeg(file = here::here("figs/qgcomp_plots/", plot_name))
plot(fit.qgcomp.b_24)
dev.off()
...
#' Save the model
model_name <- "QGComp_t2_24_st_md.rdata"
save(fit.qgcomp.c_24, fit.qgcomp.b_24,
     file = here::here("results/qgcomp_results", model_name))
...
write_csv(gcomp_psi_results, file = here::here("results/qgcomp_results/psi_est", "qgcomp_t2_psi_estimates_md.csv"))
write_csv(gcomp_weights_results, file = here::here("results/qgcomp_results/weights", "qgcomp_t2_weights_md.csv"))